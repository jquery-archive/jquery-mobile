...
<div data-role="page" class="jqm-demos ui-responsive-panel" id="panel-fixed-page1">
    ...
    <div data-role="content" class="jqm-content">
        ...
        <a href="./" data-ajax="false" class="ui-btn ui-shadow ui-corner-all ui-mini ui-btn-inline ui-icon-arrow-l ui-btn-icon-left">Back to Panels</a>
	...
	<div data-role="panel" data-position="right" data-position-fixed="true" data-display="overlay" data-theme="b" id="add-form">
        ...
        <form class="userform">
            ...
            <div class="ui-grid-a">
                ...
                <div class="ui-block-b"><a href="#" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Save</a></div>
			</div>
        </form>
