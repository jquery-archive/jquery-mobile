...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>Grids <a href="http://api.jquerymobile.com/grid-layout/" class="jqm-api-docs-link ui-btn ui-btn-icon-right ui-icon-caret-r ui-nodisc-icon ui-alt-icon ui-btn-inline ui-corner-all ui-mini">API</a></h1>
