...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>Range slider <a href="http://api.jquerymobile.com/rangeslider/" class="jqm-api-docs-link ui-button ui-icon-end ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API<span class="ui-icon ui-icon-caret-r"></span></a></h1>
