...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
        ...
        <a href="listview-grid.html" data-ajax="false" class="ui-shadow ui-button ui-corner-all ui-button-inline ui-mini ui-icon-arrow-r ui-icon-end">Open demo</a>
...
<div data-role="page" data-theme="b" id="demo-page" class="my-page">
	...
	<div data-role="header">
		<h1>Listview Responsive Grid</h1>
		<a href="./" data-shadow="false" data-iconshadow="false" data-icon="carat-l" data-iconpos="icon-only" data-rel="back" data-ajax="false">Back</a>
	</div><!-- /header -->
