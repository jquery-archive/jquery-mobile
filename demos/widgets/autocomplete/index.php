...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div data-role="content" class="jqm-content">
			...
			<p>To use the filter as an autocomplete that taps into remote data sources, you can use the <code>filtertextbeforefilter</code> event to dynamically populate a listview as a user types a search query: <a href="autocomplete-remote.php" data-ajax="false">Remote autocomplete demo</a></p>
