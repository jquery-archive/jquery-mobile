...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
			...
			<div data-role="tabs" id="tabs">
		      <div data-role="navbar">
			    <ul>
			      ...
			      <li><a href="ajax-content-ignore.jss" data-ajax="false">three</a></li>
			    </ul>
		      </div>
		...
		<div data-demo-html="true" data-demo-css="#inset-tablist">
		    ...
		    <p>You can also use tabs to swap out the contents of an entire page. See <a data-ajax="false" href="tabbed-content.jss">Tabbed Content Pages</a> for details.</p>
