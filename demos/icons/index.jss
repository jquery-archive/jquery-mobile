...
.ui-nosvg .ui-icon-myicon:after {
	background-image: url("iconimg.png");
		...
		<div data-demo-html="true">
			<a href="index.jss" class="ui-btn ui-shadow ui-corner-all ui-icon-arrow-l ui-btn-icon-left">Left</a>
			<a href="index.jss" class="ui-btn ui-shadow ui-corner-all ui-icon-arrow-r ui-btn-icon-right">Right</a>
			<a href="index.jss" class="ui-btn ui-shadow ui-corner-all ui-icon-arrow-u ui-btn-icon-top">Top</a>
			<a href="index.jss" class="ui-btn ui-shadow ui-corner-all ui-icon-arrow-d ui-btn-icon-bottom">Bottom</a>
		</div><!--/demo-html -->
        ...
        <div data-demo-html="true">
            <a href="index.jss" class="ui-btn ui-shadow ui-corner-all ui-icon-delete ui-btn-icon-notext">Delete</a>
        </div><!--/demo-html -->
        ...
        <div data-demo-html="true">
			<a href="index.jss" class="ui-shadow-icon ui-btn ui-shadow ui-corner-all ui-icon-delete ui-btn-icon-left">Icon shadow</a>
			<a href="index.jss" class="ui-shadow-icon ui-btn ui-shadow ui-corner-all ui-btn-b ui-icon-delete ui-btn-icon-left">Icon shadow</a>
        </div><!--/demo-html -->
        ...
        <div data-demo-html="true">
			<a href="index.jss" class="ui-nodisc-icon ui-btn ui-shadow ui-corner-all ui-icon-delete ui-btn-icon-left">No disc</a>
			<a href="index.jss" class="ui-nodisc-icon ui-btn ui-shadow ui-corner-all ui-btn-b ui-icon-delete ui-btn-icon-left">No disc</a>
        </div><!--/demo-html -->
        ...
        <div data-demo-html="true">
        	<a href="index.jss" class="ui-alt-icon ui-btn ui-shadow ui-corner-all ui-icon-delete ui-btn-icon-left">Alt icon</a>
			<a href="index.jss" class="ui-alt-icon ui-btn ui-shadow ui-corner-all ui-btn-b ui-icon-delete ui-btn-icon-left">Alt icon</a>
        </div><!--/demo-html -->
