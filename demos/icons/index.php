...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
        ...
        <h1>Icons <a href="http://api.jquerymobile.com/icons/" class="jqm-api-docs-link ui-button ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API <span class="ui-icon ui-icon-carat-r"></span></a></h1>
        ...
        <div data-demo-html="true">
			...
			<button class="ui-button ui-shadow ui-corner-all"><span class="ui-icon ui-icon-carat-d"></span> carat-d</button>
			<button class="ui-button ui-shadow ui-corner-all"><span class="ui-icon ui-icon-carat-l"></span> carat-l</button>
			<button class="ui-button ui-shadow ui-corner-all"><span class="ui-icon ui-icon-carat-r"></span> carat-r</button>
			<button class="ui-button ui-shadow ui-corner-all"><span class="ui-icon ui-icon-carat-u"></span> carat-u</button>
