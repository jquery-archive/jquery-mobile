...
<div data-role="page" class="jqm-demos">
	...
	<div data-role="toolbar" data-type="header" class="jqm-header">
		...
		<a href="#" class="jqm-navmenu-link ui-button ui-button-icon-only ui-shadow ui-corner-all ui-nodisc-icon ui-alt-icon ui-toolbar-header-button-left">Menu<span class="ui-icon ui-icon-bars"></span></a>
		<a href="#" class="jqm-search-link ui-button ui-button-icon-only ui-corner-all ui-nodisc-icon ui-alt-icon ui-toolbar-header-button-right ui-shadow">Search<span class="ui-icon ui-icon-search"></span></a>
	</div><!-- /header -->
