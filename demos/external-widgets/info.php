...
<body>
    ...
    <div id="shared-header" data-role="toolbar" data-toolbar-type="header" data-position="fixed" data-theme="a">
...
<?php if (!isset($_SERVER['HTTP_X_REQUESTED_WITH']) || strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) !== 'xmlhttprequest' || isset( $_GET['source'])) { ?>
	<div id="shared-navbar" data-role="toolbar" data-toolbar-type="footer" data-position="fixed" data-theme="a">
