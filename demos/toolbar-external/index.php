...
$(function(){
	$( "[data-role='header'], [data-role='footer']" ).toolbar();
			...
			<p>External toolbars are outside the page so they don't inherit a theme from the page. This means you always have to set a for them. You can use the <code>data-theme</code> attribute for this or set the <code>theme</code> option when you call the plugin:
