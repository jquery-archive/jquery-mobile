...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>Toolbar <a href="http://api.jquerymobile.com/toolbar/" class="jqm-api-docs-link ui-button ui-icon-end ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API<span class="ui-icon ui-icon-caret-r"></span></a></h1>
		...
		<div data-demo-html="true" data-demo-css="#footer-abs-buttons">
			<div data-role="footer">
				...
				<a href="#" class="ui-button ui-corner-all ui-button-inline ui-mini footer-button-right ui-icon-end">Next<span class="ui-icon ui-icon-caret-r"></span></a>
			</div>
		</div>
