...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
            ...
            <div data-demo-html="true">
                <div class="ui-field-contain">
                    <fieldset data-role="controlgroup">
                        ...
                        <button disabled="disabled" class="ui-shadow ui-button ui-corner-all ui-icon-home ui-button-icon-right">One</button>
                        <input disabled="disabled" type="button" data-icon="back" data-iconpos="right" value="Two">
                        <a href="#" class="ui-state-disabled ui-shadow ui-button ui-corner-all ui-icon-grid ui-button-icon-right">Three</a>
                    </fieldset>
                </div>
            </div><!--/demo-html -->
            ...
            <div data-demo-html="true">
                <div class="ui-field-contain">
                    <fieldset data-role="controlgroup" data-type="horizontal">
                        ...
                        <button disabled="disabled" class="ui-shadow ui-button ui-corner-all ui-icon-home ui-button-icon-right">One</button>
                        <input disabled="disabled" type="button" data-icon="back" data-iconpos="right" value="Two">
                        <a href="#" class="ui-shadow ui-state-disabled ui-button ui-corner-all ui-icon-grid ui-button-icon-right">Three</a>
                    </fieldset>
                </div>
            </div><!--/demo-html -->
            ...
            <div data-demo-html="true">
                <div class="ui-field-contain">
                    <fieldset data-role="controlgroup" data-type="horizontal">
                        ...
                        <a href="#" class="ui-shadow ui-button ui-state-disabled ui-corner-all ui-icon-arrow-r ui-button-icon-right">Link</a>
                        <button disabled="disabled" class="ui-shadow ui-button ui-corner-all ui-icon-grid ui-button-icon-notext">Button</button>
            ...
            <div data-demo-html="true">
                <div class="ui-field-contain">
                    <fieldset data-role="controlgroup" data-mini="true">
                        ...
                        <button disabled="disabled" class="ui-shadow ui-button ui-corner-all ui-icon-home ui-button-icon-right">One</button>
                        <input disabled="disabled" type="button" data-icon="back" data-iconpos="right" value="Two">
                        <a href="#" class="ui-shadow ui-button ui-state-disabled ui-corner-all ui-icon-grid ui-button-icon-right">Three</a>
                    </fieldset>
                </div>
            </div><!--/demo-html -->
        ...
        <div data-demo-html="true">
            <a href="#" class="ui-state-disabled ui-shadow ui-button ui-corner-all ui-icon-arrow-r ui-button-icon-right">Link button</a>
        </div><!--/demo-html -->

        <div data-demo-html="true">
            <a href="#" class="ui-shadow ui-button ui-corner-all ui-state-disabled ui-icon-arrow-r ui-button-icon-right ui-mini">Link button</a>
        </div><!--/demo-html -->
