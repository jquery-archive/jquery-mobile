...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
        ...
        <div data-demo-html="true" data-demo-js="#redirectCode" data-demo-php="source.jss">
            <a href="redirect.jss?to=redirect-target.jss" class="ui-shadow ui-btn ui-corner-all ui-btn-inline">Redirect</a>
        </div><!--/demo-html -->
