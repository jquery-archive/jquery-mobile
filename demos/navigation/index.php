...
$( window ).on( "navigate", function( event, data ){
	...
	alterContent( data.state.url );
		...
		<h2>Event Example <a href="http://api.jquerymobile.com/navigate/" class="jqm-api-docs-link ui-button ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API</a><span class="ui-icon ui-icon-carat-r"></span></h2>
...
$( "#event-example" ).click(function( event ) {
    ...
    <a href="#" id="event-example" class="ui-shadow ui-button ui-corner-all">Event Example</a>
		...
		<h2>Method Example <a href="http://api.jquerymobile.com/jQuery.mobile.navigate/" class="jqm-api-docs-link ui-button ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API</a><span class="ui-icon ui-icon-carat-r"></span></h2>
