...
$( window ).on( "navigate", function( event, data ){
	...
	alterContent( data.state.url );
		...
		<h2>Event Example <a href="http://api.jquerymobile.com/1.5/navigate/" class="jqm-api-docs-link ui-btn ui-btn-icon-right ui-icon-carat-r ui-nodisc-icon ui-alt-icon ui-btn-inline ui-corner-all ui-mini">API</a></h2>
...
$( "#event-example" ).click(function( event ) {
    ...
    <a href="#" id="event-example" class="ui-shadow ui-btn ui-corner-all">Event Example</a>
		...
		<h2>Method Example <a href="http://api.jquerymobile.com/1.5/jQuery.mobile.navigate/" class="jqm-api-docs-link ui-btn ui-btn-icon-right ui-icon-carat-r ui-nodisc-icon ui-alt-icon ui-btn-inline ui-corner-all ui-mini">API</a></h2>
