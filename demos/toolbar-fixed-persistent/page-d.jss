...
<body>
	...
	<div data-role="footer" data-position="fixed" data-theme="a">
		<div data-role="navbar">
			<ul>
				<li><a href="index.jss" data-prefetch="true" data-transition="fade">Info</a></li>
				<li><a href="page-b.jss" data-prefetch="true" data-transition="flip">Friends</a></li>
				<li><a href="page-c.jss" data-prefetch="true" data-transition="turn">Albums</a></li>
				<li><a href="page-d.jss" data-prefetch="true" data-transition="slide">Emails</a></li>
			</ul>
		</div><!-- /navbar -->
	</div><!-- /footer -->
