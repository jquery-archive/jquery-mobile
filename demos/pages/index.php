...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>Pages <a href="http://api.jquerymobile.com/page/" class="jqm-api-docs-link ui-button ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API <span class="ui-icon ui-icon-caret-r"></span></a></h1>
...
&lt;/div&gt;
		...
		<p>Within the "page" container, any valid HTML markup can be used, but for typical pages in jQuery Mobile, the immediate children of a "page" are divs with <code>data-role="toolbar" data-toolbar-type="header"</code>, <code>class="ui-content"</code>, and <code>data-role="toolbar" data-toolbar-type="footer"</code>.</p>

<pre><code>
&lt;div data-role="page"&gt;
	&lt;div data-role="toolbar" data-toolbar-type="header"&gt;...&lt;/div&gt;
	&lt;div role="main" class="ui-content"&gt;...&lt;/div&gt;
	&lt;div data-role="toolbar" data-toolbar-type="footer"&gt;...&lt;/div&gt;
&lt;/div&gt;
</code></pre>
