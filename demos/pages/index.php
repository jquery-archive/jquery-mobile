...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>Pages <a href="http://api.jquerymobile.com/page/" class="jqm-api-docs-link ui-button ui-icon-end ui-nodisc-icon ui-alt-icon ui-button-inline ui-corner-all ui-mini">API <span class="ui-icon ui-icon-carat-r">Icon carat right</span></a></h1>
...
&lt;/html&gt;
		...
		<a href="../pages-single-page/index.html" data-ajax="false" class="ui-button ui-shadow ui-corner-all ui-button-inline ui-mini ui-icon-arrow-r ui-icon-end">View page template</a>
...
&lt;/body&gt;
		...
		<a href="../pages-multi-page/index.html" data-ajax="false" class="ui-button ui-shadow ui-corner-all ui-button-inline ui-mini ui-icon-arrow-r ui-icon-end">View multi-page template</a>
