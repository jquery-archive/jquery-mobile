...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div data-role="content" class="jqm-content">
		...
		<p>A tooltip can be created by adding a theme swatch to a basic popup and adding padding via the <code>ui-content</code> class.</p>
			<div data-demo-html="true">
				<p class="ui-body-d" style="padding:2em;">A paragraph with a tooltip. <a href="#popupInfo" data-rel="popup"  data-role="button" class="ui-alt-icon" data-inline="true" data-transition="pop" data-icon="info" data-theme="a" data-iconpos="notext">Learn more</a></p>
		...
		<p>Learn how to customize and extend popups by working with the API, custom scripts, and styles.</p>
			<a href="popup-images.php" data-ajax="false" data-role="button" data-mini="true" data-inline="true" data-icon="arrow-r" data-iconpos="right">Scaling images</a>
			<a href="popup-iframes.php" data-ajax="false" data-role="button" data-mini="true" data-inline="true" data-icon="arrow-r" data-iconpos="right">Map + video iframes</a>
