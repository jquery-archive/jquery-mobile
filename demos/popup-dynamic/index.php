...
<div data-role="page" id="demo-intro" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
        ...
        <div data-demo-html="#demo-page" data-demo-js="true">
            ...
            <p><a href="#demo-page" data-transition="fade" class="ui-button ui-corner-all ui-shadow ui-button-inline ui-mini ui-icon-end">Open dynamic popup demo</a><span class="ui-icon ui-icon-arrow-r"></span></p>
        </div><!--/demo-html -->
