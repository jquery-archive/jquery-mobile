...
<li data-section="Demo Showcase" data-filtertext="server redirection with server-side support php"><a href="examples/redirect/index.html" data-ajax="false">Redirection with server-side support</a></li>
