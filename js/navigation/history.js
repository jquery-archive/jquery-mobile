...
(function( $, undefined ) {
	...
	var prototype = $.mobile.History.prototype;
	...
	prototype.add = function( url, data ){
		data = data || {};
	...
	prototype.clearForward = function() {
		this.stack = this.stack.slice( 0, this.activeIndex + 1 );
	};

	prototype.find = function( url, stack, earlyReturn ) {
	...
	prototype.closest = function( url ) {
	...
	prototype.direct = function( opts ) {
