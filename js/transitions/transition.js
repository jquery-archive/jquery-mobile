...
(function( $, window, undefined ) {
	...
	var prototype = $.mobile.Transition.prototype;
	prototype.toPreClass = " ui-page-pre-in";

	prototype.init = function( name, reverse, $to, $from ) {
		$.extend(this, {
			name: name,
			reverse: reverse,
			$to: $to,
	...
	prototype.beforeDoneIn = function() {};
	prototype.beforeDoneOut = function() {};
	prototype.beforeStartOut = function() {};

	prototype.doneIn = function() {
		this.beforeDoneIn();
	...
	prototype.doneOut = function( screenHeight, reverseClass, none, preventFocus ) {
		this.beforeDoneOut();
		this.startIn( screenHeight, reverseClass, none, preventFocus );
	};

	prototype.hideIn = function( callback ) {
	...
	prototype.startIn = function( screenHeight, reverseClass, none, preventFocus ) {
	...
	prototype.startOut = function( screenHeight, reverseClass, none ) {
	...
	prototype.toggleViewportClass = function() {
