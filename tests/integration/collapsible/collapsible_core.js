	...
	asyncTest( "Collapsible Set", function(){
		...
		$.testHelper.pageSequence([
			...
			function() {
				...
				ok( collapsibles.eq(1).find( ".ui-collapsible-content" ).hasClass( "ui-body-b" ), "Content of second collapsible should have class ui-body-b" );
				ok( collapsibles.eq(2).find( ".ui-collapsible-heading-toggle" ).hasClass( "ui-btn-d" ), "Heading of third collapsible should have class ui-btn-d" );
				...
				ok( collapsibles.eq(3).find( ".ui-collapsible-heading-toggle" ).hasClass( "ui-btn-d" ), "Heading of fourth collapsible should have class ui-btn-d" );
