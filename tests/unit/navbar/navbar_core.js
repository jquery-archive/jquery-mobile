...
(function($){
    ...
    test( "disabled navbar button doesn't add active button class when clicked", function() {
        var link = $("#disabled-btn-click a.ui-state-disabled").first();
    ...
    module( "navbar exceed maxbutton, without moreButton" );

    test( "exceeding default maxbutton creates a new row", function() {
    ...
    test( "override the default maxbutton works", function() {
    ...
    module( "navbar appending items and refresh, without moreButton" , {
        setup: function() {
    ...
    test( "adding items to navbar", function() {
    ...
    module( "navbar destroy, without moreButton", {
        setup: function() {
